...
@section('content')
    <form action="{{ route('submit') }}" method="post" class="addUserForm">
        @csrf
        <div class="grid lg:grid-cols-2 gap-6">
            <div class="mb-5">
                <div class="mb-2"><label for="fname" class=" font-medium text-white">First Name</label></div>
                <input type="text" value="{{ old('fname') }}" placeholder="Enter First Name" name="fname" id="fname"
            ...
            <div class="mb-5">
                ...
                <input type="text" value="{{ old('lname') }}" placeholder="Enter Last Name" id="lname"
                    name="lname"
        ...
        <div class="grid lg:grid-cols-2 gap-6">
            <div class="mb-5">
                ...
                <input type="email" value="{{ old('email') }}" placeholder="Enter Email Address" name="email"
                    id="email"
            ...
            <div class="mb-5">
                ...
                <input type="tel" value="{{ old('phone_no') }}" placeholder="Enter Mobile No" id="phone_no"
                    name="phone_no"
        ...
        <div class="grid lg:grid-cols-2 gap-6">
            <div class="mb-5">
                ...
                <input type="text" value="{{ old('city') }}" placeholder="Enter City" id="city" name="city"
                    class="bg-gray-900 focus:pl-7  border focus:shadow-blue-700 focus:shadow-lg text-white text-sm rounded-lg focus:bg-gray-900 focus:text-white duration-500 focus:ring-blue-500 border-blue-500 block w-full
                     p-2.5">
                @error('city')
                    <span class="text-red-600">
            ...
            <div class="mb-5">
                ...
                <input type="number" value="{{ old('age') }}" placeholder="Enter Age" min="1" id="age"
                    name="age"
                    class="bg-gray-900 focus:pl-7  border focus:shadow-blue-700 focus:shadow-lg text-white text-sm rounded-lg focus:bg-gray-900 focus:text-white duration-500 focus:ring-blue-500 border-blue-500 block w-full
                     p-2.5">
                @error('age')
        ...
        <div class="grid lg:grid-cols-2 gap-6">
            <div class="mb-5">
                ...
                <input type="password" value="{{ old('password') }}" placeholder="Enter Password" id="password"
                    name="password"
                    class="bg-gray-900 focus:pl-7  border focus:shadow-blue-700 focus:shadow-lg text-white text-sm rounded-lg focus:bg-gray-900 focus:text-white duration-500 focus:ring-blue-500 border-blue-500 block w-full
                     p-2.5">
                @error('password')
            ...
            <div class="mb-5">
                ...
                <input type="password" value="{{ old('cpassword') }}" placeholder="Confirm Password" id="cpassword"
                    name="cpassword"
                    class="bg-gray-900 focus:pl-7  border focus:shadow-blue-700 focus:shadow-lg text-white text-sm rounded-lg focus:bg-gray-900 focus:text-white duration-500 focus:ring-blue-500 border-blue-500 block w-full
                     p-2.5">
                @error('cpassword')
        ...
        <div class="mb-5">
            ...
            <input type="text" value="{{ old('address') }}" placeholder="Enter Address" id="address"
                name="address"
                class="bg-gray-900 focus:pl-7  border focus:shadow-blue-700 focus:shadow-lg text-white text-sm rounded-lg focus:bg-gray-900 focus:text-white duration-500 focus:ring-blue-500 border-blue-500 block w-full
                     p-2.5">
            @error('address')
